...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createFavListNavigationController() -> UINavigationController {
    ...
    func createTabBarController() -> UITabBarController {
        ...
        tabBar.viewControllers = [createSearchNavigationController(), createFavListNavigationController()]
        return tabBar
    }
